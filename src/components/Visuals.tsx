...
export const DragDropVisual = ({ lang = 'zh' }: { lang?: LangType }) => {
    ...
    return (
        <div className="relative w-full h-48 bg-slate-50 rounded-xl border border-gray-200 overflow-hidden flex shadow-inner">
            ...
            <div className="flex-1 flex flex-col p-4 relative">
                ...
                <div className="relative z-10 pl-6 mb-3">
                    <div className="flex items-center gap-2 mb-1.5 opacity-80">
                        <div className="w-2 h-2 rounded-full bg-teal-500 ring-2 ring-white shadow-sm z-10"></div>
                ...
                <div className="relative z-10 pl-6 mb-3">
                    <div className="flex items-center gap-2 mb-1.5 opacity-80">
                        <div className="w-2 h-2 rounded-full bg-teal-500 ring-2 ring-white shadow-sm z-10"></div>
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">{t.afternoon}</span>
                    </div>
                ...
                <div className="relative z-10 pl-6">
                    <div className="flex items-center gap-2 mb-1.5 opacity-80">
                        <div className="w-2 h-2 rounded-full bg-teal-500 ring-2 ring-white shadow-sm z-10"></div>
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">{t.evening}</span>
                    </div>
                    <div className="h-14 w-full max-w-[220px] rounded-xl relative">
        ...
        <div className="relative w-full h-48 bg-slate-50 rounded-xl overflow-hidden border border-gray-200 flex">
            <div className="w-1/2 h-full relative border-r border-gray-100 bg-slate-100/50 overflow-hidden">
                ...
                <svg className="absolute inset-0 w-full h-full">
                    <path d="M 30 80 Q 60 50 100 40" fill="none" stroke="#0d9488" strokeWidth="2" strokeDasharray="4,4" className="animate-draw-path" />
                </svg>
                <div className="absolute left-[30px] top-[80px] transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10">
                    <div className="w-3 h-3 bg-teal-600 rounded-full border-2 border-white shadow"></div>
                    <span className="mt-1 text-[8px] font-bold text-gray-500 bg-white/90 px-1 rounded shadow-sm backdrop-blur-sm whitespace-nowrap">{t.visualsKinkakuji}</span>
                </div>
                <div className="absolute left-[100px] top-[40px] transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10">
                    <div className="w-3 h-3 bg-teal-600 rounded-full border-2 border-white shadow"></div>
                    <span className="mt-1 text-[8px] font-bold text-gray-500 bg-white/90 px-1 rounded shadow-sm backdrop-blur-sm whitespace-nowrap">{t.visualsFushimiInari}</span>
                </div>
            </div>
            <div className="w-1/2 h-full relative flex flex-col items-center justify-center p-3 bg-white">
                ...
                <div className="h-8 w-0.5 bg-gray-200 my-1 relative flex items-center justify-center">
                    <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-1 bg-white px-2 py-0.5 rounded-full shadow-sm border border-gray-200 animate-transport-cycle-1 whitespace-nowrap z-10">
                        <Car size={8} className="text-teal-600" />
                        <span className="text-[8px] font-bold text-gray-600">15m</span>
                    </div>
                    <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-1 bg-white px-2 py-0.5 rounded-full shadow-sm border border-gray-200 animate-transport-cycle-2 whitespace-nowrap z-10 opacity-0">
                        <Train size={8} className="text-orange-500" />
                        <span className="text-[8px] font-bold text-gray-600">25m</span>
                    </div>
                    <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-1 bg-white px-2 py-0.5 rounded-full shadow-sm border border-gray-200 animate-transport-cycle-3 whitespace-nowrap z-10 opacity-0">
                        <Footprints size={8} className="text-blue-500" />
                        <span className="text-[8px] font-bold text-gray-600">45m</span>
                    </div>
                </div>
                <div className="flex items-center gap-2 w-full bg-white border border-gray-100 p-1.5 rounded-lg shadow-sm">
