...
export const SAMPLE_ASSETS: TravelItem[] = [
    // ===== TOKYO =====
    // Tokyo Attractions
    { id: 'a1', title: '淺草寺', titleEn: 'Senso-ji Temple', type: 'attraction', duration: '2小時', image: '⛩️', description: '東京最古老的寺院，雷門是必拍景點。', descriptionEn: 'Tokyo\'s oldest temple, famous for the Kaminarimon gate.', price: 0, address: '東京都台東區淺草', rating: 4.8, tips: '建議清晨前往避開人潮', x: 70, y: 30, lat: 35.7147, lng: 139.7967, funFact: '建於西元628年', openingHours: '06:00-17:00', tags: ['必去'], region: 'tokyo' },
    { id: 'a2', title: '東京晴空塔', titleEn: 'Tokyo Skytree', type: 'attraction', duration: '2小時', image: '🗼', description: '日本第一高塔，360度俯瞰東京。', descriptionEn: 'Japan\'s tallest tower with 360-degree views.', price: 3500, address: '東京都墨田區', rating: 4.7, tips: '網路預約可省排隊時間', x: 75, y: 35, lat: 35.7100, lng: 139.8107, funFact: '高度634公尺', openingHours: '10:00-21:00', tags: ['地標'], region: 'tokyo' },
    { id: 'a3', title: '澀谷十字路口', titleEn: 'Shibuya Crossing', type: 'attraction', duration: '30分', image: '🚶', description: '世界最繁忙的行人穿越道。', descriptionEn: 'The world\'s busiest pedestrian crossing.', price: 0, address: '東京都澀谷區', rating: 4.5, tips: '在星巴克二樓拍縮時攝影', x: 45, y: 60, lat: 35.6595, lng: 139.7005, funFact: '一次最多3000人同時過馬路', openingHours: '24H', tags: ['必去'], region: 'tokyo' },
    { id: 'a4', title: 'TeamLab Planets', titleEn: 'TeamLab Planets', type: 'attraction', duration: '2小時', image: '✨', description: '沉浸式數位藝術體驗，需赤腳入場。', descriptionEn: 'Immersive digital art experience. Barefoot entry required.', price: 3800, address: '東京都江東區豐洲', rating: 4.9, tips: '穿容易捲起的短褲', x: 62, y: 55, lat: 35.6465, lng: 139.7877, funFact: '會弄濕到膝蓋', openingHours: '10:00-21:00', tags: ['網美'], region: 'tokyo' },
    { id: 'a5', title: '明治神宮', titleEn: 'Meiji Jingu Shrine', type: 'attraction', duration: '1.5小時', image: '🌲', description: '都市中的森林綠洲，祭祀明治天皇。', descriptionEn: 'A forest oasis in the city, dedicated to Emperor Meiji.', price: 0, address: '東京都澀谷區代代木', rating: 4.6, tips: '參拜完可去原宿逛街', x: 40, y: 55, lat: 35.6763, lng: 139.6993, funFact: '佔地70公頃', openingHours: '日出-日落', tags: ['神社'], region: 'tokyo' },
    { id: 'a6', title: '台場鋼彈', titleEn: 'Odaiba Gundam', type: 'attraction', duration: '1小時', image: '🤖', description: '1:1實物大獨角獸鋼彈，會變形！', descriptionEn: 'Life-size Unicorn Gundam statue that transforms!', price: 0, address: '東京都江東區台場', rating: 4.4, tips: '晚上會有燈光秀', x: 60, y: 65, lat: 35.6243, lng: 139.7754, funFact: '高19.7公尺', openingHours: '24H', tags: ['動漫'], region: 'tokyo' },
    // Tokyo Food
    ...
    { id: 'h3', title: '淺草THE GATE', titleEn: 'The Gate Hotel Asakusa', type: 'hotel', duration: '過夜', image: '🛏️', description: '淺草寺旁現代設計旅館。', descriptionEn: 'Modern design hotel next to Senso-ji.', price: 15000, address: '東京都台東區', rating: 4.5, tips: '頂樓可看晴空塔', x: 70, y: 32, lat: 35.7108, lng: 139.7962, funFact: '窗外就是雷門', tags: ['位置'], region: 'tokyo' },

    // ===== OSAKA =====
    // Osaka Attractions
    { id: 'oa1', title: '通天閣', titleEn: 'Tsutenkaku Tower', type: 'attraction', duration: '1.5小時', image: '🗼', description: '大阪地標，可俯瞰新世界區。', descriptionEn: 'Osaka landmark overlooking Shinsekai.', price: 900, address: '大阪市浪速區', rating: 4.3, tips: '摸幸運神Billiken的腳會帶來好運', x: 50, y: 60, lat: 34.6524, lng: 135.5063, funFact: '靈感來自艾菲爾鐵塔', openingHours: '10:00-20:00', tags: ['地標'], region: 'osaka' },
    ...
    { id: 'of3', title: '千房大阪燒', titleEn: 'Chibo Okonomiyaki', type: 'food', duration: '1小時', image: '🥞', description: '大阪燒老字號，桌上自己煎。', descriptionEn: 'Classic Okonomiyaki restaurant.', price: 1500, address: '道頓堀', rating: 4.4, tips: '點豪華海鮮版', x: 48, y: 54, lat: 34.6680, lng: 135.5020, funFact: '1973年創業', openingHours: '11:00-23:00', tags: ['大阪燒'], region: 'osaka' },
    // Osaka Hotels
    { id: 'oh1', title: '大阪洲際酒店', titleEn: 'InterContinental Osaka', type: 'hotel', duration: '過夜', image: '🏨', description: '梅田最高樓，無敵夜景。', descriptionEn: 'Highest building in Umeda with stunning views.', price: 35000, address: '大阪市北區', rating: 4.8, tips: '記得訂高樓層', x: 52, y: 40, lat: 34.7061, lng: 135.4947, funFact: '位於Grand Front', tags: ['五星'], region: 'osaka' },
    { id: 'oh2', title: '心齋橋WBF飯店', titleEn: 'Hotel WBF Shinsaibashi', type: 'hotel', duration: '過夜', image: '🛏️', description: 'CP值超高，逛街超方便。', descriptionEn: 'Great value hotel, convenient for shopping.', price: 12000, address: '心齋橋', rating: 4.3, tips: '有溫泉大浴場', x: 48, y: 52, lat: 34.6750, lng: 135.5000, funFact: '走路5分鐘到道頓堀', tags: ['平價'], region: 'osaka' },

    // ===== KYOTO =====
    { id: 'ka1', title: '金閣寺', titleEn: 'Kinkaku-ji', type: 'attraction', duration: '1小時', image: '🕌', description: '金碧輝煌的世界遺產，正式名稱為鹿苑寺。', descriptionEn: 'The Golden Pavilion, a World Heritage site officially named Rokuon-ji.', price: 500, address: '京都市北區金閣寺町1', rating: 4.8, tips: '建議清晨開門即抵達，人潮較少', x: 40, y: 30, lat: 35.0393, lng: 135.7292, funFact: '1950年曾被僧侶縱火燒毀，現建築為1955年重建', openingHours: '09:00-17:00', tags: ['古蹟', '必去'], region: 'kyoto' },
